      ...
      while True:
         ...
         if cam_name in dictLastCameraTrigger.keys():
            ...
            if(timediff > 10):
               ...
               bot = telepot.Bot('xxxxx:xxxxxxxxxx') #insert your Bot Key
               chatid='xxxxxx' #Insert your chatID
               ...
               logger.info('Sent alert in less than the configured.No Alert send to the Bot from :%s ',cam_name)
         else:
